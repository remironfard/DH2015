...
so convenient on actual TV or cinema. For example, France Televisions' Nouvelles Ecritures\footnote{Nouvelles Ecritures is the new media departement at France Televisions producing and experimenting new format : webdoc, transmedia, virtual reality, \emph{etc.}} : \url{http://nouvelles-ecritures.francetv.fr/}} created in 2013 an augmented theater experience for the web \footnote{Théâtre sans animaux : \url{http://nouvelles-ecritures.francetv.fr/theatre-sans-animaux/}} showing five different versions of the same play \emph{Théâtre sans animaux}\footnote{\emph{Théatre sans animaux} from Jean-Michel Ribes}, showing both
...
\todo{not sure about the interest of those 2 paragraphs in this paper.} It is a difficult task to create recorded performances to match up to the live experience
...
\todo{i believe this paper talks about something else than multiplying the points of view}Our approach in this paper is to make video recordings from a single viewpoint (the director's seat) with the highest possible
