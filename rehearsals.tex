...
\subsubsection{Emerged categories} Each annotation process has revealed a set of categories reflecting both the related performing art and the personnal point of view of the operator. The tables \todo{to be linked to table figure} present the richness of the annotation and the potential of the archive for researches in genetic analysis of creative works.
\begin{tabular}{|l|c|}
\hline 
...
thanks to additional standards such as Media Fragments URI~\cite{troncy2012mediafragments}
...
Finally, we use the approach proposed by Verborgh \emph{et al.}~\cite{verborgh2014querying}
