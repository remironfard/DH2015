...
A session annotation is linked with a video file and represents a rehearsal session (typically lasting a half-day or a day). A session annotation is connected to a place (where the rehearsal takes place) and to a creation. A session annotation is made up of chapters that represent performance or discussion times. A chapter contain contextual data about this performance/discussion time (i.e. with or without costumes, lights, sets and musical inserts) and references concerned part of the work...
