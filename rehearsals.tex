...
Each annotation process has revealed a set of categories reflecting both the related performing art and the personal point of view of the operator. The tables \todo{to be linked to table figure} present the richness of the annotation and the potential of the archive for researches in genetic analysis of creative works.
